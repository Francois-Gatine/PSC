...
each json object corresponds to a publication with a main author, co-authors, title, venue title.
...
3 - [First Step] (FirstStep.ipynb)
For each ambiguous group, we compare the names of the authors 
using the fragment comparison function (fragmentComparison).
